...
export function ProdutosServicosSection({
  ...
  return (
    <>
      <div className={styles.mobileSwitcher} role="tablist" aria-label="Tipo de lançamento">
        <button
          type="button"
          role="tab"
          aria-selected={grupoMobile === 'produtos'}
          onClick={() => setGrupoMobile('produtos')}
        >
        ...
        <button
          type="button"
          role="tab"
          aria-selected={grupoMobile === 'servicos'}
          onClick={() => setGrupoMobile('servicos')}
        >
          Serviços <span>{servicos.length}</span>
        </button>
      </div>
      <div className={grupoMobile === 'produtos' ? undefined : styles.mobileHidden}>
      ...
      <div className={grupoMobile === 'servicos' ? undefined : styles.mobileHidden}>
        <h2 className={styles.heading}>
          Serviços <span>{servicos.length}</span>
        </h2>
        <ItemGrid
